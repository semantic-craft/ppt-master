...
- **Icon placeholders**: `<use data-icon="icon-name" x="" y="" width="48" height="48" fill="#HEX"/>` (auto-embedded during post-processing). Prefix with library name for tabler icons: `data-icon="tabler-filled/name"` or `data-icon="tabler-outline/name"`
