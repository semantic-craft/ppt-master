...
- **viewBox** MUST match the canvas dimensions; it is the single source of truth for canvas size. Root `width`/`height` are optional — if written, they MUST equal `viewBox`
