...
>
> Machine-readable execution contract. Executor uses the current loaded lock for each page and refreshes after changes or context loss. Values not listed here must NOT appear in SVGs. For design narrative (rationale, audience, style), see `design_spec.md`.
>
