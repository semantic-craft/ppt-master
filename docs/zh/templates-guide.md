...
完整索引见 [`templates/layouts/README.md`](../../skills/ppt-master/templates/layouts/README.md)，按"品牌 / 场景 / 政企 / 特殊"分类，每条都标注了主色和适用场景。内置模板库覆盖 Google、Anthropic、招商银行、中国电建、中汽研、政府蓝/红、医学院、心理学、像素复古等。
